    ...
    return (
        <div className="projects">
            <div className="projects__header">
                ...
                <p style={{color: "white"}}>The following {projects.length} Projects have been declared as <a href="https://creativecommons.org/share-your-work/public-domain/cc0/"><u style={{textDecorationColor: "#DB3585"}}><b>CC0</b></u></a>, and have therefore been placed in the public domain.</p>
                <p><Link to='/submit-project'>Submit your project</Link></p>
            </div>
